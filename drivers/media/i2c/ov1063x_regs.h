...
static const struct ov1063x_reg ov1063x_regs_vert_no_sub[] = {
	{ 0x381c, 0x00 }, { 0x381f, 0x0c }, { 0x4001, 0x04 }, { 0x4004, 0x08 },
	{ 0x4050, 0x20 }, { 0x4051, 0x22 }, { 0x6e47, 0x0c }, { 0x4610, 0x05 },
	{ 0x4613, 0x10 },
};

static const struct ov1063x_reg ov1063x_regs_vert_sub2[] = {
	{ 0x381c, 0x01 }, { 0x381f, 0x06 }, { 0x4001, 0x02 }, { 0x4004, 0x02 },
	{ 0x4050, 0x10 }, { 0x4051, 0x11 }, { 0x6e47, 0x06 }, { 0x4610, 0x03 },
	{ 0x4613, 0x0a },
};
