...
#define XVTC_CONTROL_HSYNC_POL_SRC		BIT(23)
#define XVTC_CONTROL_VSYNC_POL_SRC		BIT(22)
#define XVTC_CONTROL_HBLANK_POL_SRC		BIT(21)
#define XVTC_CONTROL_VBLANK_POL_SRC		BIT(20)
#define XVTC_CONTROL_CHROMA_SRC			BIT(18)
#define XVTC_CONTROL_VBLANK_HOFF_SRC		BIT(17)
#define XVTC_CONTROL_VSYNC_END_SRC		BIT(16)
#define XVTC_CONTROL_VSYNC_START_SRC		BIT(15)
#define XVTC_CONTROL_ACTIVE_VSIZE_SRC		BIT(14)
#define XVTC_CONTROL_FRAME_VSIZE_SRC		BIT(13)
#define XVTC_CONTROL_HSYNC_END_SRC		BIT(11)
#define XVTC_CONTROL_HSYNC_START_SRC		BIT(10)
#define XVTC_CONTROL_ACTIVE_HSIZE_SRC		BIT(9)
#define XVTC_CONTROL_FRAME_HSIZE_SRC		BIT(8)
...
#define XVTC_STATUS_GEN_VBLANK			BIT(12)
#define XVTC_STATUS_DET_ACTIVE_VIDEO		BIT(11)
#define XVTC_STATUS_DET_VBLANK			BIT(10)
#define XVTC_STATUS_LOCK_LOSS			BIT(9)
#define XVTC_STATUS_LOCK			BIT(8)

#define XVTC_ERROR_ACTIVE_CHROMA_LOCK		BIT(21)
#define XVTC_ERROR_ACTIVE_VIDEO_LOCK		BIT(20)
#define XVTC_ERROR_HSYNC_LOCK			BIT(19)
#define XVTC_ERROR_VSYNC_LOCK			BIT(18)
#define XVTC_ERROR_HBLANK_LOCK			BIT(17)
#define XVTC_ERROR_VBLANK_LOCK			BIT(16)

#define XVTC_IRQ_ENABLE_FSYNC(n)		((n) << 16)
#define XVTC_IRQ_ENABLE_GEN_ACTIVE_VIDEO	BIT(13)
#define XVTC_IRQ_ENABLE_GEN_VBLANK		BIT(12)
#define XVTC_IRQ_ENABLE_DET_ACTIVE_VIDEO	BIT(11)
...
#define XVTC_TIMING_STATUS_ACTIVE_VIDEO		BIT(2)
#define XVTC_TIMING_STATUS_VBLANK		BIT(1)
#define XVTC_TIMING_STATUS_LOCKED		BIT(0)
...
#define XVTC_ENCODING_CHROMA_PARITY_ODD_ALL	BIT(8)
...
#define XVTC_ENCODING_VIDEO_FORMAT_YUV444	BIT(0)
#define XVTC_ENCODING_VIDEO_FORMAT_RGB		(2 << 0)
#define XVTC_ENCODING_VIDEO_FORMAT_YUV420	(3 << 0)

#define XVTC_POLARITY				0x000c
#define XVTC_POLARITY_ACTIVE_CHROMA_POL		BIT(5)
#define XVTC_POLARITY_ACTIVE_VIDEO_POL		BIT(4)
#define XVTC_POLARITY_HSYNC_POL			BIT(3)
#define XVTC_POLARITY_VSYNC_POL			BIT(2)
#define XVTC_POLARITY_HBLANK_POL		BIT(1)
#define XVTC_POLARITY_VBLANK_POL		BIT(0)
